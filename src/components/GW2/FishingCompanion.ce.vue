...
<template>
  <div class="lbm-app">
    ...
    <div class="lbm-app__main">
      <div class="flex flex-col md:flex-row justify-between gap-4 items-center" v-if="!isLoading">
          ...
          >
            ...
            >
              <div class="lbm-indicator w-12 h-12 shrink-0">
                ...
                <img
                  :src="
                    'https://api.lebusmagique.fr/uploads/api/gw2/items/' + fish.item.uid + '.png'
                  "
