...
<script setup>
import { ref } from 'vue';
import { i18n } from '@/services/utils';
            ...
            <div v-if="itemTooltipData">
                ...
                <div v-else class="flex flex-col gap-2 text-md">
                    <div class="flex gap-3 items-center">
                        <img
                            :src="itemTooltipData.icon"
                            class="self-start rounded w-12 h-12"
                            alt=""
                        />
                        <div
                            class="font-bold text-base"
                            :class="'text-gw2-rarity-' + itemTooltipData.rarity"
                        >
                        ...
                        <div>
                            ...
                            <span
                                v-if="
                                    ...
                                    ['Default', 'Generic'].indexOf(itemTooltipData.details?.type) <
                                        0
                                "
                            >
