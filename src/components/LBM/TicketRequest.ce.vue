    ...
    <div class="bg-black bg-opacity-50 p-4 rounded-lg text-neutral-content">
        ...
        <div v-if="step === 'home'">
            <div class="grid grid-cols-3 gap-4 mb-6">
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <p>
                            Nous sommes une guilde communautaire, basée sur l'entraide et le
                            respect. Tous nos évènements sont organisés sur les serveurs européens.
                        </p>
                        <div class="lbm-card-actions">
                            ...
                            <dialog ref="communityModal" class="lbm-modal">
                                <div class="lbm-modal-box">
                                    ...
                                    <p>
                                        Nous sommes une guilde communautaire, 75% des membres de
                                        notre guilde ne représentent pas la guilde. Même lors de nos
                                        événements ce n'est pas obligatoire (sauf pour les missions
                                        de guilde où sans représentation aucun coffre n'est gagné).
                                        Tous nos évènements sont organisés sur les serveurs
                                        Européens.
                                    </p>
                                    <p>
                                        Nous promouvons l'entraide et le respect entre nos membres.
                                    </p>
                                    <p>
                                        Vous pouvez voir notre guilde comme un annuaire, une source
                                        d'information ou une aide pour se retrouver.
                                    </p>
                                </div>
                            </dialog>
                        </div>
                ...
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <p>
                            Nous organisons des événements pour lesquels souvent, vous n'avez pas
                            besoin de faire partie de la guilde.
                        </p>
                        <div class="lbm-card-actions">
                ...
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <p>
                            Nous sommes une guilde très active et vous êtes assuré d'avoir réponse à
                            vos questions en utilisant le canal guilde.
                        </p>
                        <div class="lbm-card-actions">
                ...
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <p>
                            Tous nos événements sont planifiés et vous pouvez vous y inscrire sur
                            notre Discord.
                        </p>
                    </div>
                </div>
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <p>
                            Rejoignez
                            <a :href="DISCORDURL" target="_blank">notre serveur Discord</a> pour
                ...
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <p>
                            Si vous souhaitez monter à bord du Bus pour organiser des événements
                            avec les joueuses et joueurs de GW2,
                            <a
            ...
            <div class="flex gap-4 flex-col items-center">
                ...
                <a
                    href="#!"
                    @click.prevent="goToStep('queue-request')"
            ...
            <div class="grid grid-cols-2 max-w-lg gap-4 mx-auto mb-6">
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <div class="lbm-card-actions">
                            <button class="lbm-btn lbm-btn-primary" @click="goToStep('terms')">
                                Rejoindre
                            </button>
                        </div>
                    </div>
                ...
                <div class="lbm-card">
                    <div class="lbm-card-body">
                        ...
                        <div class="lbm-card-actions">
                            <button class="lbm-btn lbm-btn-primary" @click="goToStep('form')">
                                Rejoindre
                            </button>
                        </div>
                    </div>
        ...
        <div v-else-if="step === 'terms'">
            ...
            <p>
                ...
                <strong>«&nbsp;ticket validé&nbsp;».</strong> Après une certaine période, vous serez
                dégradé en
                <strong
                    >«&nbsp;ticket neuf&nbsp;». Participez régulièrement aux événements de
                    guilde</strong
                >
                du Bus Magique pour valider votre ticket.
            </p>
            <p>
                Vous pouvez <strong>participer aux événements</strong> du Bus Magique (hors missions
                de guilde), <strong>sans avoir à rejoindre la guilde,</strong> uniquement en étant
                inscrit·e à l'événement et présent·e sur Discord au moment où ils se déroulent.
            </p>
            <p>
                Si vous <strong>n'êtes pas actives/actifs</strong> pendant la période où vous êtes
                «ticket neuf», <strong>vous descendrez du Bus.</strong>
            </p>
            <p>
                <strong>Ce n'est pas un banissement,</strong> c'est uniquement pour faire de la
                place à d'autres joueues/joueurs, puisque nous sommes limiés à 500 membres.
            ...
            <div class="lbm-form-control mb-4">
                <label class="lbm-label cursor-pointer justify-center gap-2">
                    <input
                        type="checkbox"
                        class="lbm-checkbox lbm-checkbox-success"
                        v-model="helloNoob"
                    />
                    <span class="lbm-label-text"
                        >Je n'ai pas compris le fonctionnement de la purge</span
                    >
                </label>
            </div>
        ...
        <div v-else-if="step === 'form'">
            <div class="max-w-md mx-auto">
                <label class="lbm-form-control w-full">
                    ...
                    <div class="lbm-label">
                        <span class="lbm-label-text-alt"
                            >La clé API est utilisée pour obtenir l'orthographe exacte de ton nom de
                            compte pour t'envoyer l'invitation en jeu.<br />
                ...
                <label class="lbm-form-control w-full">
                    ...
                    <div class="lbm-label">
                        <span class="lbm-label-text-alt"
                            >Vous recevez une notification par e-mail lorsque nous vous aurons
                            envoyé une invitation en jeu. Cette adresse n'est pas conservée à
                            l'issue de l'invitation.</span
                        >
                    </div>
                </label>
            </div>
        ...
        <div v-else-if="step === 'queue'">
            <div class="text-center max-w-lg mx-auto">
                ...
                <p class="text-sm">
                    ...
                    <a :href="DISCORDURL" target="_blank">notre serveur Discord</a> pour discuter
                    avec la communauté, poser vos questions et participer à nos événements qui sont
